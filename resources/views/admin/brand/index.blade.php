...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            <a class="btn btn-primary waves-effect" href="{{ route('admin.brand.create') }}">
                                    ...
                                    @foreach($brands as $key=>$brand)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.brand.edit',$brand->id) }}" class="btn btn-info waves-effect">
                                                    <i class="material-icons">edit</i>
                                                </a>
                                                <button class="btn btn-danger waves-effect" type="button" onclick="deleteTag({{ $brand->id }})">
